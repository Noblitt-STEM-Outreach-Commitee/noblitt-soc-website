...
// Tab functionality for Get Involved section
...
const scholarContactForm = document.getElementById('scholarContactForm');
...
function handleFormSubmit(form, formName) {
    form.addEventListener('submit', function(e) {
        ...
        // Simulate API call
        setTimeout(() => {
            const message = formName === 'scholar' 
...
if (scholarContactForm) {
    handleFormSubmit(scholarContactForm, 'scholar');
}
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.initiative-card, .event-card, .benefit, .option, .resource-card, .testimonial');
